...
# 多库路径（相对当前脚本）
KB_DIRS = [
    "knowledge_base/Derby_no_ca",
    "knowledge_base/Dronology_no_ca",
    "knowledge_base/Drools_no_ca",
    "knowledge_base/maven_no_ca",
    "knowledge_base/Groovy_no_ca",
    "knowledge_base/Seam2_no_ca",
    "knowledge_base/EasyClinic_no_ca",
    "knowledge_base/Pig_no_ca"
]
...
Goal: Determine whether the given requirement description and code are any related.
            ...
            for doc, score in results:
                ...
                if score > SIM_THRESHOLD:
                    ...
                    if meta_content:
                        ...
                        case_text = case_body
                    # 去掉极端长文本，避免对话超限
                    if len(case_text) > 25000:
                        case_text = case_text[:25000] + "…"
                        print("去除极端长文本")
...
if __name__ == '__main__':
    ...
    for dataset in datasets:
        input_file = f"../Dataset/{dataset}/{dataset}.xlsx"
        output_file = f"./Result/{dataset}_predict_with_instance2.xlsx"
